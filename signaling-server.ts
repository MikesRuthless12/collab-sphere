...
// Deploy this to Deno Deploy for free with paid tier options available
// This server handles WebRTC signaling for the Collab Sphere application
...
async function handler(req: Request): Promise<Response> {
  ...
  return new Response(
    JSON.stringify({
      ...
      version: '1.0.0',
      endpoints: {
        websocket: 'wss://your-deno-deploy-url.deno.dev/{roomId}',
        health: 'https://your-deno-deploy-url.deno.dev/health',
      },
    }),
    {
      headers: { 'Content-Type': 'application/json' },
